...
public interface ConditionBuilder<E, SELF extends ConditionBuilder<E, SELF>> extends ConditionalMethods<E, SELF> {
     ...
     */
    java.util.concurrent.atomic.AtomicReference<Set<String>> FROZEN_EXTRA_SAFE_FUNCTION_NAMES =
     ...
     * 启动完成后由 {@link #freezeExtraFunctionNames()} 设置。
     */
    java.util.concurrent.atomic.AtomicReference<Set<String>> FROZEN_EXTRA_BOOLEAN_FUNCTION_NAMES =
        new java.util.concurrent.atomic.AtomicReference<>(Set.of());
     ...
     *
     * <p>
     * 冻结后的 {@code contains()} 调用基于 {@link java.util.concurrent.atomic.AtomicReference} 实现无锁读取，
     * 线程安全且无竞态条件。
     */
