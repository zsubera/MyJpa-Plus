...
public class OrConditionBuilder<T, SELF extends AbstractBulkOperationSpec<T, SELF>> {
   ...
   * @return 包装后的谓词函数
   */
  private BiFunction<Root<T>, CriteriaBuilder, Predicate> leaf(
      BiFunction<Root<T>, CriteriaBuilder, Predicate> fn) {
    return fn;
  }
  ...
  public OrConditionBuilder<T, SELF> eq(SFunction<T, ?> field, Object value) {
    ...
    nodes.add(
        new BulkConditionNode.LeafNode((root, cb) -> PredicateHelper.eq(root, name, value, cb)));
    return this;
  }
  ...
  public OrConditionBuilder<T, SELF> ne(SFunction<T, ?> field, Object value) {
    String name = parent.property(field);
    nodes.add(
        new BulkConditionNode.LeafNode((root, cb) -> PredicateHelper.ne(root, name, value, cb)));
    return this;
  }
  ...
  public OrConditionBuilder<T, SELF> gt(SFunction<T, ?> field, Comparable<?> value) {
    ...
    String name = parent.property(field);
    nodes.add(
        new BulkConditionNode.LeafNode((root, cb) -> PredicateHelper.gt(root, name, value, cb)));
    return this;
  }
  ...
  public OrConditionBuilder<T, SELF> ge(SFunction<T, ?> field, Comparable<?> value) {
    ...
    String name = parent.property(field);
    nodes.add(
        new BulkConditionNode.LeafNode((root, cb) -> PredicateHelper.ge(root, name, value, cb)));
    return this;
  }
  ...
  public OrConditionBuilder<T, SELF> lt(SFunction<T, ?> field, Comparable<?> value) {
    ...
    String name = parent.property(field);
    nodes.add(
        new BulkConditionNode.LeafNode((root, cb) -> PredicateHelper.lt(root, name, value, cb)));
    return this;
  }
  ...
  public OrConditionBuilder<T, SELF> le(SFunction<T, ?> field, Comparable<?> value) {
    ...
    String name = parent.property(field);
    nodes.add(
        new BulkConditionNode.LeafNode((root, cb) -> PredicateHelper.le(root, name, value, cb)));
    return this;
  }
  ...
  public OrConditionBuilder<T, SELF> like(SFunction<T, ?> field, String value) {
    ...
    String name = parent.property(field);
    nodes.add(
        new BulkConditionNode.LeafNode((root, cb) -> PredicateHelper.like(root, name, value, cb)));
    return this;
  }
  ...
  public OrConditionBuilder<T, SELF> notLike(SFunction<T, ?> field, String value) {
    ...
    String name = parent.property(field);
    nodes.add(
        new BulkConditionNode.LeafNode(
            (root, cb) -> PredicateHelper.notLike(root, name, value, cb)));
    return this;
  }
  ...
  public OrConditionBuilder<T, SELF> startsWith(SFunction<T, ?> field, String value) {
    ...
    nodes.add(
        new BulkConditionNode.LeafNode(
            (root, cb) -> PredicateHelper.startsWith(root, name, value, cb)));
    return this;
  }
  ...
  public OrConditionBuilder<T, SELF> endsWith(SFunction<T, ?> field, String value) {
    ...
    nodes.add(
        new BulkConditionNode.LeafNode(
            (root, cb) -> PredicateHelper.endsWith(root, name, value, cb)));
    return this;
  }
  ...
  public OrConditionBuilder<T, SELF> contains(SFunction<T, ?> field, String value) {
    ...
    nodes.add(
        new BulkConditionNode.LeafNode(
            (root, cb) -> PredicateHelper.contains(root, name, value, cb)));
    return this;
  }
  ...
  public OrConditionBuilder<T, SELF> eqIgnoreCase(SFunction<T, ?> field, String value) {
    ...
    nodes.add(
        new BulkConditionNode.LeafNode(
            (root, cb) -> PredicateHelper.eqIgnoreCase(root, name, value, cb)));
    return this;
  }
  ...
  public OrConditionBuilder<T, SELF> likeIgnoreCase(SFunction<T, ?> field, String value) {
    ...
    nodes.add(
        new BulkConditionNode.LeafNode(
            (root, cb) -> PredicateHelper.likeIgnoreCase(root, name, value, cb)));
    return this;
  }
  ...
  public OrConditionBuilder<T, SELF> in(SFunction<T, ?> field, Object... values) {
    ...
    nodes.add(
        new BulkConditionNode.LeafNode((root, cb) -> PredicateHelper.in(root, name, values, cb)));
    return this;
  }
  ...
  public OrConditionBuilder<T, SELF> notIn(SFunction<T, ?> field, Object... values) {
    ...
    nodes.add(
        new BulkConditionNode.LeafNode(
            (root, cb) -> PredicateHelper.notIn(root, name, values, cb)));
    return this;
  }
  ...
  public OrConditionBuilder<T, SELF> isNotNull(SFunction<T, ?> field) {
    String name = parent.property(field);
    nodes.add(
        new BulkConditionNode.LeafNode((root, cb) -> PredicateHelper.isNotNull(root, name, cb)));
    return this;
  }
   ...
   */
  public OrConditionBuilder<T, SELF> between(
      SFunction<T, ?> field, Comparable<?> start, Comparable<?> end) {
    ...
    nodes.add(
        new BulkConditionNode.LeafNode(
            (root, cb) -> PredicateHelper.between(root, name, start, end, cb)));
    return this;
  }
   ...
   * @throws IllegalArgumentException 如果 start 或 end 为 null
   */
  public OrConditionBuilder<T, SELF> notBetween(
      SFunction<T, ?> field, Comparable<?> start, Comparable<?> end) {
    if (start == null) throw new IllegalArgumentException("start must not be null");
    if (end == null) throw new IllegalArgumentException("end must not be null");
    String name = parent.property(field);
    nodes.add(
        new BulkConditionNode.LeafNode(
            (root, cb) -> PredicateHelper.notBetween(root, name, start, end, cb)));
    return this;
  }
  ...
  public OrConditionBuilder<T, SELF> isEmpty(SFunction<T, ?> field) {
    String name = parent.property(field);
    nodes.add(
        new BulkConditionNode.LeafNode((root, cb) -> PredicateHelper.isEmpty(root, name, cb)));
    return this;
  }
  ...
  public OrConditionBuilder<T, SELF> isNotEmpty(SFunction<T, ?> field) {
    String name = parent.property(field);
    nodes.add(
        new BulkConditionNode.LeafNode((root, cb) -> PredicateHelper.isNotEmpty(root, name, cb)));
    return this;
  }
}
