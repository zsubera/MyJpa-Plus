...
/**
 * Convenience template for executing MyJpa-Plus queries and bulk operations
 * with automatic {@link EntityManager} injection.
 * <p>
 * This eliminates the need to manually pass an {@code EntityManager} to
 * {@link UpdateSpec} and {@link DeleteSpec}. Simply inject this template
 * and use its methods.
 * <p>
 * Example:
 * <pre>{@code
