...
/**
 * Utility for building JPA {@code IN} and {@code NOT IN} clauses,
 * eliminating the repetitve {@code CriteriaBuilder.In} construction pattern.
 * <p>
 * This class is used internally by {@link com.zsubera.jpa.spec.ConditionBuilder},
 * {@link com.zsubera.jpa.spec.SubQuerySpec}, and
 * {@link com.zsubera.jpa.update.AbstractBulkOperationSpec} to avoid
 * duplicating the same IN-building logic across three implementations.
 */
