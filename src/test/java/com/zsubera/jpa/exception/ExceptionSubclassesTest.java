...
class ExceptionSubclassesTest {
    ...
    // ==================== MyJpaDataAccessException ====================

    @Test
    void dataAccess_message_setsMessage() {
        MyJpaDataAccessException ex = new MyJpaDataAccessException("connection refused");
    ...
    void dataAccess_messageContextCause_setsAll() {
        ...
        MyJpaDataAccessException ex = new MyJpaDataAccessException("tx error", "UserRepository.save", cause);
    ...
    void dataAccess_isRuntimeException() {
        assertInstanceOf(RuntimeException.class, new MyJpaDataAccessException("err"));
        assertInstanceOf(MyJpaPlusException.class, new MyJpaDataAccessException("err"));
    }
