...
class UpdateSpecTest {
    ...
    void execute_clearsL1CacheSoFindHitsDatabase() {
        ...
        int count =
            new UpdateSpec<>(TestEntity.class).set(TestEntity::getName, "new").eq(TestEntity::getId, id).execute(em);
        assertEquals(1, count);
    ...
    void executeLimited_clearsL1CacheSoFindHitsDatabase() {
        ...
        int count = new UpdateSpec<>(TestEntity.class).set(TestEntity::getName, "updated").eq(TestEntity::getId, id)
    ...
    void updateAll_clearsL1CacheSoFindHitsDatabase() {
        ...
        int count =
            new UpdateSpec<>(TestEntity.class).set(TestEntity::getName, "batch").allowUnconditional(true).updateAll(em);
        assertTrue(count > 0);
