...
class MergeSpecTransactionTest {
    ...
    private void invokeSafeRollback(MergeSpec<TestEntity> spec, EntityTransaction tx, Throwable original)
        throws Exception {
        var method = MergeSpec.class.getDeclaredMethod("safeRollback", EntityTransaction.class, Throwable.class);
        method.setAccessible(true);
        try {
