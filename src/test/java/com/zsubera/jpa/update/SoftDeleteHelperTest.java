...
class SoftDeleteHelperTest {
  ...
  @Autowired private SoftDeleteTestEntityRepository repository;
  ...
  void testIsNotDeletedFiltersOutSoftDeletedRecords() {
    ...
    Specification<SoftDeleteTestEntity> spec =
        SoftDeleteHelper.isNotDeleted(SoftDeleteTestEntity.class);
  ...
  void testIsDeletedReturnsOnlySoftDeletedRecords() {
    ...
    Specification<SoftDeleteTestEntity> spec =
        SoftDeleteHelper.isDeleted(SoftDeleteTestEntity.class);
    List<SoftDeleteTestEntity> result = repository.findAll(spec);
  ...
  void testSpecCacheReturnsSameInstance() {
    Specification<SoftDeleteTestEntity> spec1 =
        SoftDeleteHelper.isNotDeleted(SoftDeleteTestEntity.class);
    Specification<SoftDeleteTestEntity> spec2 =
        SoftDeleteHelper.isNotDeleted(SoftDeleteTestEntity.class);
