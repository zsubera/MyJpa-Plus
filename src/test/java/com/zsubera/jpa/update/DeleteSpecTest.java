...
class DeleteSpecTest {
    ...
    void execute_clearsL1CacheSoFindReturnsNull() {
        ...
        int count = new DeleteSpec<>(TestEntity.class).eq(TestEntity::getId, id).execute(em);
        assertEquals(1, count);
    ...
    void executeLimited_clearsL1CacheSoFindReturnsNull() {
        ...
        int count = new DeleteSpec<>(TestEntity.class).eq(TestEntity::getId, id).executeLimited(em, 100);
        assertEquals(1, count);
