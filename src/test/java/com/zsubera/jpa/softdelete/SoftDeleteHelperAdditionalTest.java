...
class SoftDeleteHelperAdditionalTest {
    ...
    void softDeleteAll_booleanType_executes() {
        ...
        int updated = SoftDeleteHelper.softDeleteAll(em, SoftDeleteTestEntity.class, true);
    ...
    void softDeleteAll_integerType_executes() {
        ...
        int updated = SoftDeleteHelper.softDeleteAll(em, SoftDeleteIntTestEntity.class, true);
        assertTrue(updated >= 1);
    ...
    void softDeleteAll_stringType_executes() {
        ...
        int updated = SoftDeleteHelper.softDeleteAll(em, SoftDeleteStringTestEntity.class, true);
        assertTrue(updated >= 1);
    ...
    void softDeleteAll_enumType_executes() {
        ...
        int updated = SoftDeleteHelper.softDeleteAll(em, SoftDeleteEnumTestEntity.class, true);
        assertTrue(updated >= 1);
    ...
    void softDeleteAll_withMaxRowsLimit_doesNotThrowWhenUnder() {
        ...
        int updated = SoftDeleteHelper.softDeleteAll(em, SoftDeleteTestEntity.class, true, 100);
        assertTrue(updated >= 1);
    }
    ...
    void softDeleteAll_withUnlimitedRows_executes() {
        ...
        int updated = SoftDeleteHelper.softDeleteAll(em, SoftDeleteTestEntity.class, true, -1);
        assertTrue(updated >= 1);
    }
    ...
    void softDeleteByIds_booleanType_executes() {
        ...
        int updated = SoftDeleteHelper.softDeleteByIds(em, SoftDeleteTestEntity.class, List.of(e1.getId()));
    ...
    void softDeleteByIds_integerType_executes() {
        ...
        int updated = SoftDeleteHelper.softDeleteByIds(em, SoftDeleteIntTestEntity.class, List.of(e1.getId()));
        assertEquals(1, updated);
    ...
    void softDeleteByIds_stringType_executes() {
        ...
        int updated = SoftDeleteHelper.softDeleteByIds(em, SoftDeleteStringTestEntity.class, List.of(e1.getId()));
        assertEquals(1, updated);
    ...
    void softDeleteByIds_enumType_executes() {
        ...
        int updated = SoftDeleteHelper.softDeleteByIds(em, SoftDeleteEnumTestEntity.class, List.of(e1.getId()));
        assertEquals(1, updated);
    ...
    void softDeleteByIds_emptyIds_returnsZero() {
        int updated = SoftDeleteHelper.softDeleteByIds(em, SoftDeleteTestEntity.class, List.of());
        assertEquals(0, updated);
    }

    @Test
    void softDeleteByIds_nullIds_returnsZero() {
        int updated = SoftDeleteHelper.softDeleteByIds(em, SoftDeleteTestEntity.class, null);
        assertEquals(0, updated);
    }
    ...
    void softDeleteByIds_exceedsHardLimit_throws() {
        ...
        assertThrows(IllegalArgumentException.class,
            () -> SoftDeleteHelper.softDeleteByIds(em, SoftDeleteTestEntity.class, ids));
    }

    @Test
    void softDeleteAll_noSoftDeleteField_throws() {
        assertThrows(IllegalArgumentException.class, () -> SoftDeleteHelper.softDeleteAll(em, TestEntity.class, true));
    }
    ...
    void softDeleteByIds_noSoftDeleteField_throws() {
        assertThrows(IllegalArgumentException.class,
            () -> SoftDeleteHelper.softDeleteByIds(em, TestEntity.class, List.of(1L)));
    }
    ...
    void softDeleteAll_integerTypeWithMaxRows_executes() {
        ...
        int updated = SoftDeleteHelper.softDeleteAll(em, SoftDeleteIntTestEntity.class, true, 100);
        assertTrue(updated >= 1);
    }
    ...
    void softDeleteAll_stringTypeWithMaxRows_executes() {
        ...
        int updated = SoftDeleteHelper.softDeleteAll(em, SoftDeleteStringTestEntity.class, true, 100);
        assertTrue(updated >= 1);
    }
    ...
    void softDeleteAll_enumTypeWithMaxRows_executes() {
        ...
        int updated = SoftDeleteHelper.softDeleteAll(em, SoftDeleteEnumTestEntity.class, true, 100);
        assertTrue(updated >= 1);
    }
    ...
    void softDeleteByIds_multipleIds_executes() {
        ...
        int updated = SoftDeleteHelper.softDeleteByIds(em, SoftDeleteTestEntity.class, List.of(e1.getId(), e2.getId()));
        assertEquals(2, updated);
    }

    @Test
    void softDeleteByIds_nonexistentIds_returnsZero() {
        int updated = SoftDeleteHelper.softDeleteByIds(em, SoftDeleteTestEntity.class, List.of(999999L));
        assertEquals(0, updated);
    }
